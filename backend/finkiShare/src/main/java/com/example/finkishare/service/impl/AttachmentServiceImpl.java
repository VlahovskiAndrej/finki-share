...
public class AttachmentServiceImpl implements AttachmentService {
    ...
    @Override
    public Attachment saveAttachment(MultipartFile file, String description, Long subjectId) throws Exception {
    ...
    public List<Attachment> getAllAttachmentsBySubject(long subjectId) {
        ...
        List<Attachment> a = attachmentRepository.findAllBySubjectDetails(s);
        return a;
    }
}
